...
const mockUserStats = {
    data: {
        ...
        data: {
            ...
            posts: [{ _id: 'post1' }, { _id: 'post2' }],
            followers: [{ _id: 'follower1' }, { _id: 'follower2' }, { _id: 'follower3' }],
            following: [{ _id: 'following1' }],
            totalLikes: 25
        }
    }
};
    ...
    describe('Authenticated User View (Dashboard)', () => {
        ...
        it('should display quick stats dashboard with gradient background', async () => {
            ...
            await waitFor(() => {
                ...
                expect(within(statsCard).getByText('25')).toBeInTheDocument(); // total likes
            });
        });
        ...
        it('should display recent activity section with loading state', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('Another interesting post about React development')).toBeInTheDocument();
            });
        });
        ...
        it('should display trending topics in sidebar', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('#JavaScript 234')).toBeInTheDocument();
            });
        });
